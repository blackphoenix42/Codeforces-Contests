 ...
 *    Created: 2025-07-22 20:14:30
 *    Profile: https://codeforces.com/profile/BinaryPhoenix10
 *    Group: Codeforces - Educational Codeforces Round 181 (Rated for Div. 2)
 *    Problem Name: E. Sets of Complementary Sums
 *    Problem URL: https://codeforces.com/contest/2125/problem/E
 *    Time Limit: 2000 ms
...
void solve() {
    ...
    vi part(Dmax + 1, 0);
    part[0] = 1;
    for (int coin = 1; coin <= k && coin <= Dmax; ++coin) {
        for (ll s = coin; s <= Dmax; ++s) {
            part[s] = mod_add(part[s], part[s - coin]);
        }
    }
