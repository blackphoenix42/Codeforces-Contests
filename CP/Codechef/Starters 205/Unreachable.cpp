/**
 *    Created: 2025-09-24T20:00:50+05:30
 *    Quote: Anything added dilutes everything else.
 *    Group: CodeChef - START205A
 *    Problem Name: Unreachable
 *    Problem URL: https://www.codechef.com/START205A/problems/BLREACH
 *    Time Limit: 1000 ms
 *    Memory Limit: 256 MB
 **/
...
void solve() {
    ...
    bool bodd = (odd2 > 0 && odd1 == 0);
    bool beven = (even2 > 0 && even1 == 0);
    cout << (bodd || beven ? "Yes" : "No") << "\n";
}
