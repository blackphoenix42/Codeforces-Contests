 ...
 *    Created: 2025-07-16 20:00:58
 *    Profile: https://codeforces.com/profile/IndianTourist01
 *    Group: CodeChef - START195A
 *    Problem Name: Game (Easy)
 *    Problem URL: https://www.codechef.com/START195A/problems/GAMEEZ
 *    Time Limit: 1000 ms
 *    Memory Limit: 256 MB
 **/
...
void solve() {
    ...
    for (int k = 1; k <= maxK; k++) {
        ...
        for (int t = t_min; t <= t_max; t++) {
            int b = k - t;
            // bonus = sum_{h=t-b to t-1} h = b*(3t-k-1)/2
            ll bonus = (ll)b * (3LL * t - k - 1) / 2;
            ll curr = pref[t] + bonus;
            best = max(best, curr);
        }
        ans[k] = best;
    }
