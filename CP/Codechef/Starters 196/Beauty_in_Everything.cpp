 ...
 *    Created: 2025-07-23 20:03:29
 *    Profile: https://codeforces.com/profile/BinaryPhoenix10
 *    Group: CodeChef - START196A
 *    Problem Name: Beauty in Everything
 *    Problem URL: https://www.codechef.com/START196A/problems/BINSUBGR
 *    Time Limit: 1000 ms
 *    Memory Limit: 256 MB
 **/
...
void solve() {
    ...
    if (N >= 4) {
        for (int i = 0; i + 3 < N; ++i) {
            if (A.compare(i, 4, "0101") == 0 || A.compare(i, 4, "1010") == 0) {
                ans = max(ans, 4);
            }
        }
    }
