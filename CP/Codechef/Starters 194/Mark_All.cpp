 ...
 *    Created: 2025-07-13 20:01:47
 *    Profile: https://codeforces.com/profile/IndianTourist01
 *    Group: CodeChef - START194B
 *    Problem Name: Mark All
 *    Problem URL: https://www.codechef.com/START194B/problems/MARKALL
 *    Time Limit: 1000 ms
 *    Memory Limit: 256 MB
 **/
...
void solve() {
    ...
    vector<ll> fm_val(N + 1, INF64), sm_val(N + 1, INF64);
    vector<int> fm_idx(N + 1, -1), sm_idx(N + 1, -1);
    ll firstVal = INF64, secondVal = INF64;
