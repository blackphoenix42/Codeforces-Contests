 ...
 *    Created: 2025-07-30 20:05:28
 *    Profile: https://codeforces.com/profile/BinaryPhoenix10
 *    Group: CodeChef - START197A
 *    Problem Name: Expected Cost
 *    Problem URL: https://www.codechef.com/START197A/problems/EVCOST
 *    Time Limit: 1000 ms
 *    Memory Limit: 256 MB
 **/
...
void solve() {
    ...
    double next = 0.0;
    for (int i = N; i >= 1; i--) {
        double dpi = min(a[i] + next, b[i] + lo);
        next = dpi;
    }
    double answer = next;
